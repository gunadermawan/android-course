        ...
        setContent {
            CourseAppTheme {
                Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
                    HearAnimation(modifier = Modifier.padding(innerPadding))
                }
            }
        }
    }
...
@Composable
fun HearAnimation(modifier: Modifier = Modifier) {
    val color by animateColorAsState(
        targetValue = if (isSystemInDarkTheme()) Color.Red else Color.Black,
